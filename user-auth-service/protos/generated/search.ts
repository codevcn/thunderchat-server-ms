...
export interface MessageMappingsService {
  CreateMessageMappings(
    request: CreateMessageMappingsRequest
  ): Observable<CreateMessageMappingsResponse>
  GetMessageMappings(request: Empty): Observable<GetMessageMappingsResponse>
  UpdateMessageMappings(
    request: UpdateMessageMappingsRequest
  ): Observable<UpdateMessageMappingsResponse>
}
