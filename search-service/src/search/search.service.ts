...
export class SearchService {
  ...
  async searchConversations(
    ...
    const directChatResults: TConversationSearchResult[] = directChats.map(
      (chat) => {
        const otherUser =
    ...
    const groupChatResults: TConversationSearchResult[] = groupChats.map(
      (chat) => ({
        id: chat.id,
