...
export interface IMessagingEmitSocketEvents {
  ...
  [EMessagingEmitSocketEvents.send_message_direct]: (payload: TGetDirectMessagesMessage) => void
  ...
  [EMessagingEmitSocketEvents.recovered_connection]: (messages: TGetDirectMessagesMessage[]) => void
  [EMessagingEmitSocketEvents.message_seen_direct]: (payload: TMsgStatusPayload) => void
  [EMessagingEmitSocketEvents.typing_direct]: (isTyping: boolean, directChatId: number) => void
  [EMessagingEmitSocketEvents.friend_request_action]: (payload: TFriendRequestPayload) => void
  ...
  [EMessagingEmitSocketEvents.send_message_group]: (newMessage: TMessageFullInfo) => void
