...
export const ConnectedClientsCountResponse: MessageFns<ConnectedClientsCountResponse> = {
  encode(message: ConnectedClientsCountResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.count !== 0) {
  ...
  create<I extends Exact<DeepPartial<ConnectedClientsCountResponse>, I>>(base?: I): ConnectedClientsCountResponse {
...
export const EmitToDirectChatRequest: MessageFns<EmitToDirectChatRequest> = {
  encode(message: EmitToDirectChatRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.event !== "") {
  ...
  create<I extends Exact<DeepPartial<EmitToDirectChatRequest>, I>>(base?: I): EmitToDirectChatRequest {
    return EmitToDirectChatRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EmitToDirectChatRequest>, I>>(object: I): EmitToDirectChatRequest {
    const message = createBaseEmitToDirectChatRequest();
...
export const SendNewMessageToGroupChatRequest: MessageFns<SendNewMessageToGroupChatRequest> = {
  encode(message: SendNewMessageToGroupChatRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
