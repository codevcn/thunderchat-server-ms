...
async function bootstrap() {
  await beforeLaunch()
  console.log('>>> Microservice [User-Service] is launching...')
  ...
  console.log(`>>> Microservice [User-Service] is listening on: ${HOST_ADDRESS}:${GRPC_PORT}`)

  await app.listen(PORT, '0.0.0.0')
  console.log(`>>> HTTP Server [User-Service] is listening on: ${HOST_ADDRESS}:${PORT}`)
}
bootstrap()
